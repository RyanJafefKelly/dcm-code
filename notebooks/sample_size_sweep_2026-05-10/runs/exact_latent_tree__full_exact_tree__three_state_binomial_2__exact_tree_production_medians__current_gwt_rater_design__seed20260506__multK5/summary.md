...
|---|---|---|---|---|---|---|
| Chicken | 0.250 | 0.131 | 0.007 | 0.519 | -0.119 | True |
| 2024 Leading Chat LLMs | 0.100 | 0.182 | 0.011 | 0.576 | 0.082 | True |

## Label Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 18 | -0.295 | 0.295 | 0.348 | 0.111 |
...
| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 75 | -0.227 | 0.227 | 0.266 | 0.080 |
...
|---|---|---|---|---|---|
| delta_j | 50 | 0.362 | 0.362 | 0.373 | 0.000 |
| q_gap_999_001 | 50 | 0.361 | 0.361 | 0.372 | 0.000 |

## Internal State Probability Scores

| n | mean_relative_entropy_reduction | mean_brier | mean_neg_log_score |
|---|---|---|---|
| 100.000 | 0.262 | 0.137 | 0.464 |
