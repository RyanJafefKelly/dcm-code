...
Elapsed build seconds: 6.3
Elapsed sample seconds: 829.8
Divergences: 0
Max R-hat: 1.0100
Min bulk ESS: 2900
...
|---|---|---|---|---|---|---|
| Chicken | 0.250 | 0.118 | 0.006 | 0.460 | -0.132 | True |
| 2024 Leading Chat LLMs | 0.100 | 0.123 | 0.007 | 0.484 | 0.023 | True |

## Label Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 18 | -0.303 | 0.304 | 0.357 | 0.111 |
| beta_pres | 18 | 0.112 | 0.123 | 0.174 | 0.389 |

## Edge Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 75 | -0.237 | 0.239 | 0.277 | 0.080 |
| beta_pres | 75 | 0.080 | 0.085 | 0.118 | 0.440 |

## Path Summary Recovery

| estimand | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| delta_j | 50 | 0.378 | 0.378 | 0.388 | 0.000 |
| q_gap_999_001 | 50 | 0.377 | 0.377 | 0.387 | 0.000 |

## Internal State Probability Scores

| n | mean_relative_entropy_reduction | mean_brier | mean_neg_log_score |
|---|---|---|---|
| 100.000 | 0.518 | 0.216 | 0.663 |
