...
|---|---|---|---|---|---|---|
| Chicken | 0.250 | 0.108 | 0.005 | 0.443 | -0.142 | True |
| 2024 Leading Chat LLMs | 0.100 | 0.111 | 0.007 | 0.431 | 0.011 | True |

## Label Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 18 | -0.357 | 0.357 | 0.404 | 0.000 |
| beta_pres | 18 | 0.164 | 0.165 | 0.211 | 0.167 |

## Edge Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 75 | -0.292 | 0.292 | 0.325 | 0.000 |
| beta_pres | 75 | 0.134 | 0.135 | 0.160 | 0.093 |

## Path Summary Recovery

| estimand | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| delta_j | 50 | 0.599 | 0.599 | 0.605 | 0.000 |
| q_gap_999_001 | 50 | 0.598 | 0.598 | 0.604 | 0.000 |

## Internal State Probability Scores

| n | mean_relative_entropy_reduction | mean_brier | mean_neg_log_score |
|---|---|---|---|
| 100.000 | 0.639 | 0.275 | 0.979 |
