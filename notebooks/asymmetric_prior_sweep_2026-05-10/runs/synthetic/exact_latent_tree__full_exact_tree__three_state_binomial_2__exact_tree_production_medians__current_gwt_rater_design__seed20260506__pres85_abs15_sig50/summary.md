...
|---|---|---|---|---|---|---|
| Chicken | 0.250 | 0.133 | 0.007 | 0.496 | -0.117 | True |
| 2024 Leading Chat LLMs | 0.100 | 0.138 | 0.007 | 0.525 | 0.038 | True |

## Label Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 18 | -0.232 | 0.241 | 0.296 | 0.444 |
| beta_pres | 18 | 0.053 | 0.101 | 0.143 | 0.722 |

## Edge Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 75 | -0.161 | 0.169 | 0.214 | 0.600 |
| beta_pres | 75 | 0.017 | 0.058 | 0.090 | 0.893 |

## Path Summary Recovery

| estimand | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| delta_j | 50 | 0.168 | 0.169 | 0.193 | 0.460 |
| q_gap_999_001 | 50 | 0.168 | 0.169 | 0.193 | 0.460 |

## Internal State Probability Scores

| n | mean_relative_entropy_reduction | mean_brier | mean_neg_log_score |
|---|---|---|---|
| 100.000 | 0.420 | 0.160 | 0.484 |
