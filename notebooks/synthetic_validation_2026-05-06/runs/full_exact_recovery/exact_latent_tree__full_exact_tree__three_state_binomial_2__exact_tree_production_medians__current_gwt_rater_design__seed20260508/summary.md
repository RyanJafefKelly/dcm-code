...
Elapsed build seconds: 5.7
Elapsed sample seconds: 1002.0
Divergences: 0
Max R-hat: 1.0000
Min bulk ESS: 2134
...
|---|---|---|---|---|---|---|
| Chicken | 0.250 | 0.123 | 0.005 | 0.507 | -0.127 | True |
| 2024 Leading Chat LLMs | 0.100 | 0.122 | 0.005 | 0.494 | 0.022 | True |

## Label Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 18 | 0.049 | 0.070 | 0.084 | 1.000 |
| beta_pres | 18 | -0.037 | 0.046 | 0.062 | 1.000 |

## Edge Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 75 | 0.039 | 0.082 | 0.095 | 1.000 |
| beta_pres | 75 | -0.047 | 0.050 | 0.063 | 1.000 |

## Path Summary Recovery

| estimand | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| delta_j | 50 | -0.055 | 0.055 | 0.065 | 0.840 |
| q_gap_999_001 | 50 | -0.055 | 0.055 | 0.064 | 0.840 |

## Internal State Probability Scores

| n | mean_relative_entropy_reduction | mean_brier | mean_neg_log_score |
|---|---|---|---|
| 100.000 | 0.375 | 0.123 | 0.391 |
