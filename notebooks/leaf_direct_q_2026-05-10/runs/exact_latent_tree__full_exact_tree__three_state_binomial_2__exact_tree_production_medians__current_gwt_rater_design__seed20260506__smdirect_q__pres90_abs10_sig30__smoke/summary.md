...
Elapsed build seconds: 4.1
Elapsed sample seconds: 285.5
Divergences: 0
Max R-hat: 1.0400
Min bulk ESS: 90
...
|---|---|---|---|---|---|---|
| Chicken | 0.250 | 0.110 | 0.006 | 0.400 | -0.140 | True |
| 2024 Leading Chat LLMs | 0.100 | 0.107 | 0.003 | 0.382 | 0.007 | True |

## Label Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 18 | -0.306 | 0.307 | 0.360 | 0.111 |
| beta_pres | 18 | 0.115 | 0.126 | 0.176 | 0.389 |

## Edge Beta Recovery

| kind | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| beta_abs | 75 | -0.242 | 0.243 | 0.281 | 0.080 |
| beta_pres | 75 | 0.085 | 0.091 | 0.123 | 0.440 |

## Path Summary Recovery

| estimand | n | mean_signed_error | mae | rmse | coverage_94 |
|---|---|---|---|---|---|
| delta_j | 50 | 0.391 | 0.391 | 0.400 | 0.000 |
| q_gap_999_001 | 50 | 0.390 | 0.390 | 0.399 | 0.000 |

## Internal State Probability Scores

| n | mean_relative_entropy_reduction | mean_brier | mean_neg_log_score |
|---|---|---|---|
| 100.000 | 0.475 | 0.211 | 0.621 |
